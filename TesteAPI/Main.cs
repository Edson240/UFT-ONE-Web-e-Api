/***************************************************************
    ...
    *  loss of information.
    *          
    *  To edit the test, open the file ‘TesteAPI.st’ 
    *  in HP Service Test.
     ***************************************************************/
    ...
    {    
        ...
        internal void InitializeComponent()
        {
            ...
            _flow.Sequence9.Activities.Add (_flow.ConcatenateStringsActivity5);
            _flow.Sequence9.Activities.Add (_flow.HTTPActivity8);
            _flow.Sequence9.Activities.Add (_flow.HTTPActivity4);
            _flow.Sequence9.Activities.Add (_flow.Loop7);
            _flow.ConcatenateStringsActivity5.Prefix = @"https://gorest.co.in/public/v2/users";
            _flow.ConcatenateStringsActivity5.Suffix = @"/12345";
            ...
            _flow.HTTPActivity8.Url = @"";
            _flow.HTTPActivity8.HttpMethod = @"GET";
            ...
            _flow.HTTPActivity8.RequestBodyType = @"Text";
...
@"<Arguments><ResponseHttpVersion /><StatusCode /><StatusDescription /><ResponseBody /><ResponseBodyAsBase64 /></Arguments>");
            ...
            _flow.HTTPActivity4.Url = @"https://gorest.co.in/public/v2/users";
            ...
            _flow.HTTPActivity4.RequestHeaders[0].Key = @"";
            _flow.HTTPActivity4.RequestHeaders[0].Value = @"";
...
@"<Array jsonType=""Array"" isAnonymous=""true""><Object jsonType=""Object"" isAnonymous=""true""><id jsonType=""Integer"">5816791</id><name jsonType=""String"">Marut Ganaka</name><email jsonType=""String"">marut_ganaka@schiller.test</email><gender jsonType=""String"">female</gender><status jsonType=""String"">active</status></Object><Object jsonType=""Object"" isAnonymous=""true""><id jsonType=""Integer"">5816790</id><name jsonType=""String"">Nirbhay Malik Sr.</name><email jsonType=""String"">sr_malik_nirbhay@lang.example</email><gender jsonType=""String"">male</gender><status jsonType=""String"">inactive</status></Object><Object jsonType=""Object"" isAnonymous=""true""><id jsonType=""Integer"">5816789</id><name jsonType=""String"">Aalok Dhawan DC</name><email jsonType=""String"">dc_aalok_dhawan@hammes.example</email><gender jsonType=""String"">male</gender><status jsonType=""String"">active</status></Object><Object jsonType=""Object"" isAnonymous=""true""><id jsonType=""Integer"">5816787</id><name jsonType=""String"">Sucheta Asan</name><email jsonType=""String"">asan_sucheta@moen-satterfield.example</email><gender jsonType=""String"">female</gender><status jsonType=""String"">active</status></Object><Object jsonType=""Object"" isAnonymous=""true""><id jsonType=""Integer"">5816786</id><name jsonType=""String"">Dron Acharya</name><email jsonType=""String"">dron_acharya@skiles.test</email><gender jsonType=""String"">female</gender><status jsonType=""String"">active</status></Object><Object jsonType=""Object"" isAnonymous=""true""><id jsonType=""Integer"">5816785</id><name jsonType=""String"">Shridevi Naik IV</name><email jsonType=""String"">naik_shridevi_iv@macejkovic-west.test</email><gender jsonType=""String"">male</gender><status jsonType=""String"">active</status></Object><Object jsonType=""Object"" isAnonymous=""true""><id jsonType=""Integer"">5816784</id><name jsonType=""String"">Devani Khatri</name><email jsonType=""String"">khatri_devani@stanton.example</email><gender jsonType=""String"">male</gender><status jsonType=""String"">active</status></Object><Object jsonType=""Object"" isAnonymous=""true""><id jsonType=""Integer"">5816783</id><name jsonType=""String"">Kailash Khatri II</name><email jsonType=""String"">ii_kailash_khatri@heidenreich.test</email><gender jsonType=""String"">male</gender><status jsonType=""String"">active</status></Object><Object jsonType=""Object"" isAnonymous=""true""><id jsonType=""Integer"">5816782</id><name jsonType=""String"">Maheswar Adiga DC</name><email jsonType=""String"">adiga_dc_maheswar@marvin.example</email><gender jsonType=""String"">male</gender><status jsonType=""String"">inactive</status></Object><Object jsonType=""Object"" isAnonymous=""true""><id jsonType=""Integer"">5816781</id><name jsonType=""String"">Deeptimay Nehru</name><email jsonType=""String"">nehru_deeptimay@rolfson-braun.example</email><gender jsonType=""String"">female</gender><status jsonType=""String"">inactive</status></Object></Array>");
...
@"<Arguments><ResponseHttpVersion /><StatusCode></StatusCode><StatusDescription /><ResponseBody /><ResponseBodyAsBase64 /></Arguments>");
            ...
            VTDPropertyInfoBase pi1 = new VTDPropertyInfoBase("XMLResponse","count(/*[local-name(.)='Array'][1]/*[local-name(.)='Object'])");
            VTDBaseGetter binding_getter1 = new VTDJsonGetter(pi1);
            VTDPropertyInfoBase pi2 = new VTDPropertyInfoBase("NumberOfIterations");
            VTDBaseSetter binding_setter1 = new VTDObjectSetter(pi2);
            bind_dir1 = new BindDirection(_flow.HTTPActivity4,binding_getter1,binding_setter1,BindTargetType.ToInProperty);
            _flow.Loop7.InDirections.Add(bind_dir1);
            _flow.Loop7.Activities.Add (_flow.Sequence10);
            ...
            _flow.SetEnvironmentVariableActivity6.VariableKey = @"teste";
            _flow.SetEnvironmentVariableActivity6.VariableValue = @"{Step.ResponseJsonBody.HTTPActivity4.Object[{Step.OutputProperties.Loop7.CurrentIterationNumber}].id}";
            ...
            VTDPropertyInfoBase pi3 = new VTDPropertyInfoBase("CurrentIterationNumber");
            VTDBaseGetter binding_getter2 = new VTDObjectGetter(pi3);
            VTDPropertyInfoBase pi4 = new VTDPropertyInfoBase("XMLResponse","/*[local-name(.)='Array'][1]/*[local-name(.)='Object'][{Array0}]/*[local-name(.)='id'][1]");
            VTDBaseGetter binding_getter3 = new VTDJsonGetter(pi4);
            binding_getter3 = new XPathGetterDecorator(binding_getter3,"{Array0}",binding_getter2,_flow.Loop7);
            VTDPropertyInfoBase pi5 = new VTDPropertyInfoBase("VariableValue");
            VTDBaseSetter binding_setter2 = new VTDObjectSetter(pi5);
            binding_setter2 = new StringFormaterDecorator(binding_setter2,"{Step.ResponseJsonBody.HTTPActivity4.Object[{Step.OutputProperties.Loop7.CurrentIterationNumber}].id}");
            bind_dir2 = new BindDirection(_flow.HTTPActivity4,binding_getter3,binding_setter2,BindTargetType.ToInProperty);
            _flow.SetEnvironmentVariableActivity6.InDirections.Add(bind_dir2);
